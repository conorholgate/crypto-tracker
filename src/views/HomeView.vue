            ...
            <div class="flex flex-col">
                <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                    <div class="flex items-center justify-end px-8">
                        <p class="">Show</p>
                        <div class="p-2 ml-2 bg-white rounded-md cursor-pointer w-14 focus:outline-none" @mouseenter="showLimit = true" @mouseleave="showLimit = false" @click="showLimit = true">
                    ...
                    <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                        ...
                        <div v-if="filteredCoins.length >= cryptoStore.sort.selectedLimit" class="flex justify-center mt-4">
                            <div class="">
                                ...
                                <a class="relative inline-flex items-center px-2 py-2 mr-1 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-l-md hover:bg-gray-50" @click="activePage > 1 ? activePage-- : '', previousPage()">
                                    <span class="sr-only">Previous</span>
                                    <ChevronLeftIcon class="w-5 h-5" aria-hidden="true" />
                                </a>
                                <div class="flex items-center" v-for="(number, index) in pages" :key="index">
                                    <div 
                                        class="relative w-12 p-4 mr-1 text-sm font-medium text-center text-gray-500 bg-white border border-gray-300 hover:bg-gray-50"
                                        :class="activePage === pages[index] ? 'bg-indigo-50 border-indigo-500 text-indigo-600' : ''">
                                        {{ number }}
                                    </div>
                                </div>
                                <a class="relative inline-flex items-center px-2 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-r-md hover:bg-gray-50" @click="activePage++, nextPage()">
